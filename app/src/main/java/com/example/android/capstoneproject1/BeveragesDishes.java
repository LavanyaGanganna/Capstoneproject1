...
public class BeveragesDishes extends AppCompatActivity implements StartersAdapter.DataTransferInterface {
    ...
    ArrayList<Starterclass> beveragelist = new ArrayList<>();

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_beverages_dishes);
        ...
        for (int j = 72; j < 80; j++) {
            beveragelist.add(DatabaseList.fullmenulist.get(j));
        }
        recyclerView = (RecyclerView) findViewById(R.id.recyclebeverage);
        ...
        StartersAdapter startersAdapter = new StartersAdapter(BeveragesDishes.this, beveragelist, itemcnt, price);
        ...
        cartbutton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent = new Intent(BeveragesDishes.this, ViewSummary.class);
        ...
        getSupportActionBar().setTitle("Beverage");
    }
