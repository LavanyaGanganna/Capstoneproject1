...
public class BirdsNest extends AppCompatActivity implements StartersAdapter.DataTransferInterface {
    ...
    ArrayList<Starterclass> birddishlist = new ArrayList<>();

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_birds_nest);
        ...
        for (int j = 34; j < 40; j++) {
            birddishlist.add(DatabaseList.fullmenulist.get(j));
        }
        recyclerView = (RecyclerView) findViewById(R.id.recyclebird);
        ...
        StartersAdapter startersAdapter = new StartersAdapter(BirdsNest.this, birddishlist, itemcnt, price);
        ...
        cartbutton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent = new Intent(BirdsNest.this, ViewSummary.class);
        ...
        getSupportActionBar().setTitle(R.string.chicken);
    }
