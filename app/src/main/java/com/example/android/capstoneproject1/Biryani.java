...
public class Biryani extends AppCompatActivity implements StartersAdapter.DataTransferInterface {
    ...
    ArrayList<Starterclass> biryanilist = new ArrayList<>();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        for (int j = 47; j < 55; j++) {
            biryanilist.add(DatabaseList.fullmenulist.get(j));
        }
        recyclerView = (RecyclerView) findViewById(R.id.recyclebiry);
        ...
        StartersAdapter startersAdapter = new StartersAdapter(Biryani.this, biryanilist, itemcnt, price);
        ...
        cartbutton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent = new Intent(Biryani.this, ViewSummary.class);
        ...
        getSupportActionBar().setTitle(R.string.biryani);
    }
