...
public class BreadsDishes extends AppCompatActivity implements StartersAdapter.DataTransferInterface {
    ...
    ArrayList<Starterclass> breadslist = new ArrayList<>();

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_breads_dishes);
        ...
        for (int j = 59; j < 67; j++) {
            breadslist.add(DatabaseList.fullmenulist.get(j));
        }
        recyclerView = (RecyclerView) findViewById(R.id.recyclebreads);
        ...
        StartersAdapter startersAdapter = new StartersAdapter(BreadsDishes.this, breadslist, itemcnt, price);
        ...
        cartbutton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent = new Intent(BreadsDishes.this, ViewSummary.class);
        ...
        getSupportActionBar().setTitle(R.string.breads);
    }
