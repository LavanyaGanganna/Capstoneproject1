...
public class DessertsDishes extends AppCompatActivity implements StartersAdapter.DataTransferInterface {
    ...
    ArrayList<Starterclass> desertlist = new ArrayList<>();

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_desserts_dishes);
        ...
        for (int j = 67; j < 72; j++) {
            desertlist.add(DatabaseList.fullmenulist.get(j));
        }
        recyclerView = (RecyclerView) findViewById(R.id.recycledeserts);
        ...
        StartersAdapter startersAdapter = new StartersAdapter(DessertsDishes.this, desertlist, itemcnt, price);
        ...
        cartbutton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent = new Intent(DessertsDishes.this, ViewSummary.class);
        ...
        getSupportActionBar().setTitle(R.string.dessert);
    }
