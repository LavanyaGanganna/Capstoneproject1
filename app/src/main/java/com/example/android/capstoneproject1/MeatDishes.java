...
public class MeatDishes extends AppCompatActivity implements StartersAdapter.DataTransferInterface {
    ...
    ArrayList<Starterclass> meatlist = new ArrayList<>();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        recyclerView = (RecyclerView) findViewById(R.id.recyclemeat);
