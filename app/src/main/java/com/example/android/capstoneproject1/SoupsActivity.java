...
public class SoupsActivity extends AppCompatActivity implements StartersAdapter.DataTransferInterface {
    ...
    ArrayList<Starterclass> soupslist = new ArrayList<>();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        for (int j = 17; j < 20; j++) {
            soupslist.add(DatabaseList.fullmenulist.get(j));
        }
        recyclerView = (RecyclerView) findViewById(R.id.recyclesoup);
        ...
        StartersAdapter startersAdapter = new StartersAdapter(SoupsActivity.this, soupslist, itemcnt, price);
        ...
        cartbutton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent = new Intent(SoupsActivity.this, ViewSummary.class);
        ...
        getSupportActionBar().setTitle(R.string.soupe);
    }
